...
| Start a temporary runner from the phone (`provision`) | **partial** | the same shape — the client call is on both phones, nothing offers it. `fleet_provision` works from the MCP server |
